defmodule Covid19bg.Source do
  defmodule LocationData do
    defstruct [
      active: 0, recovered: 0, area: "UNKNOWN", place: "UNKNOWN", total: 0, dead: 0, rank: 0
    ]
    ...
    def add_summary([%__MODULE__{} | _] = data, parent_location) do
      data
      |> Enum.reduce(%__MODULE__{area: parent_location, place: parent_location, rank: ""}, fn location_data, summary ->
        %__MODULE__{
          active: active,
          recovered: recovered,
          total: total,
        ...
        %__MODULE__{
          summary | active: active + active_summary, recovered: recovered + recovered_summary, total: total + total_summary, dead: dead + dead_summary
        }
      end)
    end
  end
